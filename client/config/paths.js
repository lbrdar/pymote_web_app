...
const resolveClient = relativePath => path.resolve(appDirectory + '/client/', relativePath);
...
const getPagePath = (page) => resolveClient('src/pages') + '/' + page + '/index';

// config after eject: we're in ./config/
module.exports = {
  dotenv: resolveApp('.env'),
  appBuild: resolveClient('build'),
